...
module.exports = {
  ...
  // /** Query the locations as geojson, for a given type */
  // getBattleLocations: async () => {
  //   const battleLocationQuery = `
  //     SELECT ID_Battle, Name_Battle, ST_AsGeoJSON(Place_Battle)
  //     FROM Battle;`
  //   const result = await client.query(battleLocationQuery)
  //   return result.rows
  // },
  //
  // /** Query the locations as geojson, for a given type */
  // getHouseBattleInfo: async (idBattle) => {
  //   const battleLocationQuery = `
  //     SELECT ST_AsGeoJSON(geog), name, gid
  //     FROM House;`
  //   const result = await client.query(houseBattleInfoQuery)
  //   return result.rows
  // },
